...
We'll think of the variance and covariance rules as one big list. We left off on [**Rule 4**](#Rule4), so now we'll introduce [**Rule 5**](#Rule5).
...
The next three rules are analogous to similar rules for variance ([**Rule 1**](#Rule1), [**Rule 2**](#Rule2), and [**Rule 3**](#Rule3)).
