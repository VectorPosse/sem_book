...
In other words, we can think of the error variance as a *proportion* of the total variance of $Y$, and then $R^2$ is the complementary proportion. Therefore, $R^{2}$ is the proportion of the variance *explained by the model*.
