...
$$
For reasons that we won't explain here (but will be explained in Chapter \@ref(path)), this type of path does *not* imply any kind of association between $X$ and $E$. Therefore, the model *does* imply that $X$ and $E$ are independent, and, therefore, $Cov(E, X) = 0$.
