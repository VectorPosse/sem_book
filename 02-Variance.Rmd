...
## Standard deviation {#variance_standard-deviation}
...
2. We need to standardize variables. (See Section [FIGURE OUT SECTION LINKING] below.)
...
## Standardizing data {#variance_standardizing}

After we've mean centered the data, we can go one step further.
