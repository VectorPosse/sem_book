...
We'll think of the variance and covariance rules as one big list. We left off on \protect\hyperlink{Rule4}{\textbf{Rule 4}}, so now we'll introduce \protect\hyperlink{Rule5}{\textbf{Rule 5}}.
...
The next three rules are analogous to similar rules for variance (\protect\hyperlink{Rule1}{\textbf{Rule 1}}, \protect\hyperlink{Rule2}{\textbf{Rule 2}}, and \protect\hyperlink{Rule3}{\textbf{Rule 3}}).
...
What you should appreciate here is that there is no longer any restriction on the relationships among the variables involved. \protect\hyperlink{Rule2}{\textbf{Rule 2}} only worked when the two variables were independent. On the other hand, \protect\hyperlink{Rule8}{\textbf{Rule 8}} works for any combination of variables, no matter their relation.
...
Yay! The minus sign behaves sensibly now! Of course, since covariance can be positive or negative (unlike variance which is always positive!) we can more safely subtract two of them without worry.

There are versions of these rules with the addition or subtraction on the other side, but these are just minor variations of \protect\hyperlink{Rule8}{\textbf{Rule 8}} and \protect\hyperlink{Rule9}{\textbf{Rule 9}}, so they're not worth mentioning as a separate rule:
