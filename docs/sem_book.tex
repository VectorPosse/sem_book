...
The next four rules are analogous to similar rules for variance (\protect\hyperlink{Rule1}{\textbf{Rule 1}}, \protect\hyperlink{Rule2}{\textbf{Rule 2}}, \protect\hyperlink{Rule3}{\textbf{Rule 3}}, and \protect\hyperlink{Rule4}{\textbf{Rule 4}}).
