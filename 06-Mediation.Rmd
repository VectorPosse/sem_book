...
This does not mean that $X_{1}$ and $X_{2}$ are uncorrelated. They may be correlated, but this correlation must arise from the some other source---either "nature", external to the model, or some other path (perhaps a mediator or confounder) in the model along a path that doesn't pass through $Y_{1}$.
